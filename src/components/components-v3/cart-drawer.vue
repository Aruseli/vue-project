...
<template>
  <transition name="drawer_animation">
    <div class="drawer_style_v3 bg-grey-3" v-if="props.isOpen">
      <div class="full-height q-pa-xl">
        ...
        <div class="q-mb-lg-md q-mb-xs-sm">
          <div class="row items-center justify-between q-mb-lg-md q-mb-xs-xs">
            <div class="text-h2 text-left text-white text-uppercase col-10  text-weight-bold">
              {{ $t('order') }}
            </div>
            ...
            >
              ...
              <div class="row justify-between col">
                ...
                <div class="column justify-evenly">
                    <!-- title -->
                    <div
                      class="text-h4 text-green text-weight-bold first_letter"
                    >
                      {{ item.title }}
                    </div>
                    <!-- price -->
                    <div class="row items-baseline">
                      <span
                        class="text-white text-weight-bold text-h5 q-mr-xs"
                      >
                        &#3647&ensp;{{ item.price * item.quant }}
                      </span>
                      <span
                        class="q-mr-xs text-white text-weight-bold text-h5"
                      >/</span>
                      <span class="text-grey text-weight-bold text-body1">
        ...
        <div class="full-width total_style bg-grey-3" v-if="cartStore.cart.length">
          <div
            ...
            <div
              class="text-white text-h4 q-px-xl no-margin row justify-between fit"
            >
              <div>{{ $t('total') }}</div>
            </div>
