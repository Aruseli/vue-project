...
<template>
  <div class="toast_container row justify-between items-center pa-20 bg-grey-2">
    <div class="column">
    ...
    <div role="button" class="text-h4 text-green text-uppercase" @click="emit('click')">{{ $t('view_order') }} <q-icon name="arrow_forward_ios" class="text-green" size="2.5em" /></div>
  </div>
</template>
